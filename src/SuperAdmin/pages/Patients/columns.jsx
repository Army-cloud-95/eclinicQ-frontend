...
export const getPatientColumns = (onOpenLog, onSchedule) => [
    ...
    },
    {
        ...
        width: 140,
        render: (row) => <span className="text-secondary-grey400 text-sm">{row.id}</span>
    },
    {
        key: 'contact',
        header: <TableHeader label="Contact Number" />,
        width: 160,
        render: (row) => <span className="text-secondary-grey400 text-sm">{row.contact}</span>
    },
    {
        key: 'email',
        ...
        render: (row) => <span className="text-secondary-grey400 text-sm">{row.email}</span>
    },
    {
        key: 'location',
