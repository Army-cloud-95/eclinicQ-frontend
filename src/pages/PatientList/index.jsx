...
const samplePatients = [
  ...
  { name: 'Arjun Singh', gender: 'F', dob: '09/21/1988 (35Y)', patientId: 'P456789', contact: '+91 7654321098', email: 'suresh.patel@mail.com', location: 'Jaipur, RJ', lastVisit: '02/02/2025 | 12:30 PM', reason: 'Follow-up visit for ongoing treatment.' },
  { name: 'Kavya Nair', gender: 'M', dob: '05/16/1987 (36Y)', patientId: 'P789123', contact: '+91 5432109876', email: 'vikram.agarwal@service.com', location: 'Chennai, TN', lastVisit: '02/02/2025 | 12:30 PM', reason: 'Evaluation of recent weight and fatigue.' },
];
